...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "4bb3d5dd5e5e52c235632ef4ef14fc5bd2645b4e75ca497d"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:format"
  # config.datastore_root_path = "/Users/evanx/work/cmbo_blue/public/system/refinery/resources"
